    ...
    // Dashboard Routes
    {
      ...
      children: [
        ...
        },
        {
          path: 'units',
          children: [
            { element: <Navigate to="/cortexa/units/list" replace />, index: true },
            { path: 'list', element: <UnitList /> },
            { path: 'new', element: <UnitCreate /> },
            { path: 'edit/:unitId', element: <UnitCreate /> },
          ],
        },
        {
          path: 'agents',
...
const UnitList = Loadable(lazy(() => import('../pages/unit/UnitList')));
const UnitCreate = Loadable(lazy(() => import('../pages/unit/UnitCreate')));
